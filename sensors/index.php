...
$data["stat"]["pos"]["left"]   = (int)($v[10]+$v[12]+$v[5]+$v[6]+$v[7]+$v[8]+$v[0]+$v[1]+$v[2]);
$data["stat"]["pos"]["center"] = (int)($v[14]+$v[16]+$v[9]+$v[11]+$v[13]+$v[15]+$v[17]+$v[19]+$v[21]+$v[3]+$v[4]+$v[26]+$v[27]);
$data["stat"]["pos"]["right"]  = (int)($v[18]+$v[20]+$v[22]+$v[23]+$v[24]+$v[25]+$v[28]+$v[29]+$v[30]);
